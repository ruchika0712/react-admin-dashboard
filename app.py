...
apiKey = 'AIzaSyBwvm3l-X6sHO2tx4YwSJwg5Qg6C3W4buQ'
...
print("Checkpoint 7: Initializing the tokenizer and Model.")
...
alldata["allComments"] = positiveComments + neutralComments + negetiveComments
